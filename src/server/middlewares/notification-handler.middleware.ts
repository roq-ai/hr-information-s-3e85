...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Payroll processed.update': {
    roles: ['owner', 'admin', 'hr-manager', 'business-owner', 'payroll-administrator', 'accountant'],
    key: 'payroll_processed',
    tenantPath: [],
    userPath: [],
  },
  'Employee status updated.update': {
    roles: ['owner', 'admin', 'hr-manager', 'business-owner'],
    key: 'employee_status_updated',
    tenantPath: [],
    userPath: [],
  },
  'New financial report.create': {
    roles: ['owner', 'admin', 'business-owner', 'accountant'],
    key: 'new_financial_report',
    tenantPath: [],
    userPath: [],
  },
};
